...
"""
Currently a duplicate of feature_model_D_1_1 after some experimentation.
...
Uses simple and ordinal encoding for all data, except for age, which is 
...
def get_data(data_directory: str = data_directory):
    ...
    complete_ordinal_data = pd.DataFrame(complete_ordinal_data,
                                         columns=incomplete_ordinal_cols)
