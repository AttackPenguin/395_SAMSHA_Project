...
Uses one hot and ordinal encoding for all data, except for age, which is 
...
def get_data(data_directory: str = data_directory):
    ...
    imputer = IterativeImputer(missing_values=-1, sample_posterior=True,
                               initial_strategy='most_frequent', verbose=2)
    imputer.fit(X_train)
