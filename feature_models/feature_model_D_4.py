...
Age categories are re-encoded as ratio data using the midpoint of the 
categories.

Uses simple imputation to replace missing values for ordinal data with most 
frequently used values.

Helmert encoding is used for categorical data.
